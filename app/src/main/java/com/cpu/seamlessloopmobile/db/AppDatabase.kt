...
import com.cpu.seamlessloopmobile.model.PlayQueueItem
import com.cpu.seamlessloopmobile.model.PlayQueueDao

import androidx.room.TypeConverters

@Database(entities = [Song::class, Playlist::class, PlaylistItem::class, PlaylistFolder::class, PlayQueueItem::class], version = 8, exportSchema = false)
